<h1 align="center">👋 Hi, I'm Ilia (ikovalll)</h1>
...
- 🧪 Writing tests with pytest and unittest
- 🐳 Containerising projects with Docker and Nginx
- ⚙️ Automating deployment with GitHub Actions
- 📚 Currently learning asynchronous Python and FastAPI
...
| Layer | Technologies |
|---|---|
| **Backend** | Python · Django · Django REST Framework · Flask · Djoser · SimpleJWT |
| **Databases** | PostgreSQL · SQLite · Django ORM · SQLAlchemy |
| **Testing** | pytest · pytest-django · unittest · Postman |
| **DevOps** | Docker · Docker Compose · Nginx · Gunicorn · GitHub Actions |
| **Tools** | Git · GitHub · Linux · Alembic · flake8 |
| **Frontend (basics)** | React · Bootstrap · HTML · CSS |
